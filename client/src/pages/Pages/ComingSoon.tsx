        ...
        <div className="no-scrollbar overflow-y-auto py-20">
          <div className="mx-auto w-full max-w-[600px]">
            <div className="text-center">
              ...
              <button
                onClick={() => navigate(-1)}
                className="mt-4 inline-flex items-center justify-center rounded-lg bg-primary px-4 py-2 text-white hover:bg-opacity-90"
              >
                <svg
          ...
          <div className="mt-10 flex justify-center">{/* <CountDownTimer /> */}</div>
          {/* <!-- Countdown timer start --> */}
